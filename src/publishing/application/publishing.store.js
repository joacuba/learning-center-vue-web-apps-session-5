...
// Actions
    function fetchCategories() {
        return publishingApi.getCategories()
            .then(response => {
    ...
    function fetchTutorials() {
        return publishingApi.getTutorials()
            .then(response => {
    ...
    function addCategory(category) {
        return publishingApi.createCategory(category)
            .then(response => {
    ...
    function addTutorial(tutorial) {
        return publishingApi.createTutorial(tutorial)
            .then(response => {
                const resource = response.data
    ...
    function updateTutorial(tutorial) {
        publishingApi.updateTutorial(tutorial.id, tutorial).then(response => {
            const resource = response.data
