...
export class TutorialAssembler {
    static toEntityFromResource(resource) {
        ...
        //return new Category({...resource}) -> this is redundant not need to use spread operator
        // return new Category(resource) -> this is the same as above not need to use spread operator
    }
